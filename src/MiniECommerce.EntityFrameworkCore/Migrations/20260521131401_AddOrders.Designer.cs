...
namespace MiniECommerce.Migrations
{
    ...
    [Migration("20260521131401_AddOrders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniECommerce.Categories.Category", b =>
                {
                    b.HasOne("MiniECommerce.Categories.Category", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("MiniECommerce.Orders.OrderItem", b =>
                {
                    b.HasOne("MiniECommerce.Orders.Order", "Order")
                        .WithMany("Items")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MiniECommerce.Products.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("MiniECommerce.Products.Product", b =>
                {
                    b.HasOne("MiniECommerce.Categories.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MiniECommerce.Categories.Category", null)
                        .WithMany("Products")
