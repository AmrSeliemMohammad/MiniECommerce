...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 580a8437-7817-41b3-b105-9d3846151e70
```

> `580a8437-7817-41b3-b105-9d3846151e70` is the password of the certificate, you can change it to any password you want.
